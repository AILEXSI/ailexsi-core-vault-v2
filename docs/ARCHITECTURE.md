# Architecture — AILEXSI Core Vault V2
...
| Repository | Role |
|------------|------|
| `ailexsi-core` | Verified Cortex baseline — **READ ONLY** for V2 work |
| `ailexsi-core-vault` | Capability reference baseline — **READ ONLY** |
| `ailexsi-core-vault-v2` | Active experimental successor — **only write target** |
