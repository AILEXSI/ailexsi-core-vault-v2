...
const aliases = {
  ...
  "@ailexsi/persistence": path.join(core, "packages/infrastructure/persistence/src/index.ts"),
  "@ailexsi/projections": path.join(core, "packages/infrastructure/projections/src/index.ts"),
};
